...
public class SubscribeController {
    ...
    public String subscribe(@RequestParam String email) {
        ...
        try {
            ...
            String htmlContent = "<div style=\"font-family: Arial, sans-serif; max-width: 600px; margin: auto; padding: 20px; background-color: #ffffff; border: 1px solid #ddd; border-radius: 8px; box-shadow: 0 0 10px rgba(0,0,0,0.05);\">"
                    // logo
                    + "<div style='text-align:center; margin-bottom: 20px;'>"
                    + "<img src='http://yourdomain.com/assets/img/logo.png' alt='AI.S Logo' style='max-width:120px; height:auto;'/>"
                    + "</div>"

                    // tiêu đề
                    + "<h2 style=\"color: #007bff; text-align: center; margin-top: 0;\">Đơn Đăng Ký Mới</h2>"
                    ...
                    // chi tiết đơn
                    + "<h4 style=\"color: #0056b3; margin-top: 25px; margin-bottom: 15px;\">Chi tiết Đơn Đăng Ký:</h4>"
            ...
            helper.setFrom("yourgmail@gmail.com"); // Thay thế bằng Gmail thật của bạn
            helper.setTo("dang542003@gmail.com"); // email nhận
            helper.setSubject(subject);
            helper.setText(htmlContent, true); // Đặt tham số thứ hai là true để báo hiệu đây là nội dung HTML
